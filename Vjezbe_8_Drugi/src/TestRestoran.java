/*
Test:
- koristi tvoje klase Konobari, Kuvari, Menadzer, Zaposleni (koje već imaš)
- postavlja sate, prekovremene i bonuse
- dodaje smjene (da pokažemo i automatski obračun)
- generiše obračun i ukupni trošak
*/
public class TestRestoran {
    public static void main(String[] args) {
        Restoran r = new Restoran("Bistro Cetinje", "Njegoševa 12", "PIB-123456");

        // Tvoji konstruktori (prema priloženim fajlovima):
        // Konobari(int id, String ime, String prezime, double plataPoSatu, double ukupanBrojSati)
        // Kuvari(int id, String ime, String prezime, double plataPoSatu, int ukupanBrojSati)
        // Menadzer(int id, String ime, String prezime, double plataPoSatu, double ukupanBrojSati, double bonus)
        ...
        // Postavi “ručno” sate/prekovremene/bonuse (koristi tvoje settere u Zaposleni)
        ...
        m1.setUkupanBrojSati(180);  /* bonus već preko konstruktora */
        ...
        // A) Bez smjena (koristi “ručno” sate)
        System.out.println("\n--- OBRACUN (bez smjena) ---");
        r.mjesecniTrosakPlata(11, 2025);

        // B) Sa smjenama (ako postoji bar jedna za dati mjesec, svi sati idu iz smjena)
