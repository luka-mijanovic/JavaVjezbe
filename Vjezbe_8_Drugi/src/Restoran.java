...
- lista smjena
Funkcije:
- dodajZaposlenog, ukloniZaposlenogPoId, pronadjiPoId
- dodajSmjenu
- ukupnoSatiIzSmjena(id, mjesec, godina)
- generisiObracun(mjesec, godina): štampa tabelu i vraća listu ObracunPlate
- mjesecniTrosakPlata(mjesec, godina): štampa ukupan trošak i vraća vrijednost
NAPOMENA:
Poštuje tvoje postojeće klase. Ako postoji bar jedna smjena za dati mjesec/godinu,
za sve zaposlene sati se uzimaju iz smjena; u suprotnom koriste se "ručno postavljeni" sati
u objektu Zaposleni (getUkupanBrojSati()).
*/
