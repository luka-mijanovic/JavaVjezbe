public abstract class Zaposleni {
	...
	private double plataPoSatu; // for manager it can represent monthly salary
	private double ukupanBrojSati; // can be fractional

	// New fields
	private int prekovremeniSati;
	private double bonus; // bonus in EUR
	...
	// Subclasses override this to implement type-specific rules
